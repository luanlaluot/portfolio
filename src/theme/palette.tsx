...
export type TPalette = {
  ...
  primary: TColorPalette;
  secondary: TColorPalette;
  info: TColorPalette;
  success: TColorPalette;
  warning: TColorPalette;
  error: TColorPalette;
  grey: {
    0: string;
    100: string;
